            ...
            <CardContent className="p-4 h-fit md:h-[450px] overflow-y-auto scrollbar-hide">
              <div className="space-y-2">
                {collateralAssets.map((asset, index) => (
                  <div
                    key={index}
                    className={`card-dark rounded-lg p-3 cursor-pointer transition-all hover:glow-purple ${collateralAsset?.symbol === asset.symbol ? "border-purple-500/50 glow-purple bg-purple-500/5" : ""
                      }`}
                      ...
                      <TabsContent value="borrow" className="space-y-3">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="bg-slate-800/50 rounded-lg p-3">
                            <Slider value={ltv} onValueChange={handleLtvChange} max={maxLtv} min={10} step={5} className="w-full" />
              ...
              <tbody>
                {userBorrowPositions.map((position, index) => (
                  <tr key={index} className="border-b border-slate-800/50">
                    ...
                    <td className="text-right py-4">
                      <div className="flex justify-end space-x-2">
                        <Button size="sm" onClick={() => handleRepayClick(position)} variant="outline" className="text-xs h-7 px-2">
                          Repay
                        </Button>
                        <Button size="sm" variant="outline" className="text-xs h-7 px-2">
                          <ExternalLink className="h-3 w-3" />
