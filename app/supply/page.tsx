                ...
                <div className="md:col-span-7 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Button
                        variant="outline"
                        className={`token-selector-dark p-2 h-auto flex-col space-y-1 rounded-lg ${paymentMethod === "crypto" ? "border-blue-500 bg-blue-500/10 glow-purple" : ""
                          }`}
                      ...
                      <Button
                        variant="outline"
                        className={`token-selector-dark p-2 h-auto flex-col space-y-1 rounded-lg ${paymentMethod === "fiat" ? "border-cyan-500 bg-cyan-500/10 glow-purple" : ""
                          }`}
